...
flextable(predictions %>% select(-Pb_at_length, -Pb_geom_mean, -lat, -long, -length, -Pb_mean, - X1OHPyr_mean)) %>%
  set_header_labels(length = "length [cm]",
                    Hg_at_length = "Hg [µg/kg WM]",
...
\
\
Tab x. Sample numbers per heavy metal
