...
flextable(predictions %>% select(-Pb_at_length, -Pb_geom_mean, -lat, -long)) %>%
  set_header_labels(X1OHPyr_mean = "1OHPyr_mean") %>% 
  autofit()
...
ggplot(data = predictions) +
  ...
  annotation_scale(location = "tl", width_hint = 0.3, pad_y = unit(0.85, "in"), pad_x = unit(0.2, "in")) +
    annotation_north_arrow(location = "tl", which_north = "true", 
        ...
        style = north_arrow_fancy_orienteering) +
  geom_point (data = predictions, aes(x = long, y = lat, color = Hg_at_length), 
        shape = 16, size = 4.5) +
...
ggplot(data = predictions) +
  ...
  annotation_scale(location = "tl", width_hint = 0.3, pad_y = unit(0.85, "in"), pad_x = unit(0.2, "in")) +
    annotation_north_arrow(location = "tl", which_north = "true", 
        pad_x = unit(0.48, "in"), pad_y = unit(0.15, "in"),
        style = north_arrow_fancy_orienteering) +
  geom_point (data = predictions, aes(x = long, y = lat, color = Cd_at_length), 
        shape = 16, size = 4.5) +
  scale_color_viridis_c()+
  geom_text_repel(aes(label = station, x = long, y = lat), size = 3, max.overlaps = 100, 
                  nudge_x = ifelse(predictions$station == "Martil", 1, 
...
ggplot(data = predictions) +
  ...
  annotation_scale(location = "tl", width_hint = 0.3, pad_y = unit(0.85, "in"), pad_x = unit(0.2, "in")) +
    annotation_north_arrow(location = "tl", which_north = "true", 
        pad_x = unit(0.48, "in"), pad_y = unit(0.15, "in"),
        style = north_arrow_fancy_orienteering) +
  geom_point (data = predictions, aes(x = long, y = lat, color = Pb_mean), 
        shape = 16, size = 4.5) +
  scale_color_viridis_c()+
  geom_text_repel(aes(label = station, x = long, y = lat), size = 3, max.overlaps = 100, 
                  nudge_x = ifelse(predictions$station == "Martil", 1, 
...
ggplot(data = predictions) +
  ...
  annotation_scale(location = "tl", width_hint = 0.3, pad_y = unit(0.85, "in"), pad_x = unit(0.2, "in")) +
    annotation_north_arrow(location = "tl", which_north = "true", 
        pad_x = unit(0.48, "in"), pad_y = unit(0.15, "in"),
        style = north_arrow_fancy_orienteering) +
  geom_point (data = predictions, aes(x = long, y = lat, color = X1OHPyr_mean), 
        shape = 16, size = 4.5) +
  scale_color_viridis_c()+
  geom_text_repel(aes(label = station, x = long, y = lat), size = 3, max.overlaps = 100, 
                  nudge_x = ifelse(predictions$station == "Martil", 1, 
