...
```{r, create  map, fig.keep='all', fig.align="default"}
...
ggplot(data = world) +
  geom_sf(color = "black", fill = "moccasin", data = land) +
  geom_sf(color = "black", fill = "moccasin", data = morocco) +
  geom_sf(color = "black", fill = "lightskyblue", data = ocean) +
  ...
  coord_sf(xlim = c(-1.00, -17.50), ylim = c(21.00, 36.50), expand = T)
